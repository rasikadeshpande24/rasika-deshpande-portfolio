        ...
        "InteractiveBackground.useEffect": ()=>{
                ...
                "InteractiveBackground.useEffect.createBubbles": (count)=>{
                    ...
                    bubblesRef.current = Array.from({
                        ...
                        "InteractiveBackground.useEffect.createBubbles": ()=>{
                            // Bias horizontally toward the sides (70% chance side, 30% center)
            ...
            const handleClick = {
                "InteractiveBackground.useEffect.handleClick": (e)=>{
                    ...
                    console.log('InteractiveBackground click', {
                        x,
                        y,
                        rect
                    });
                    const hitIndex = bubblesRef.current.findIndex({
                        "InteractiveBackground.useEffect.handleClick.hitIndex": (b)=>{
                            const dx = b.x - x;
                            const dy = b.y - y;
                            return dx * dx + dy * dy <= b.radius * b.radius;
                        }
                    }["InteractiveBackground.useEffect.handleClick.hitIndex"]);
                    if (hitIndex >= 0) {
                        const b = bubblesRef.current[hitIndex];
                        for(let i = 0; i < 12; i++){
                        ...
                        }["InteractiveBackground.useEffect.handleClick"], 800 + Math.random() * 1200);
                        setScore({
                            "InteractiveBackground.useEffect.handleClick": (s)=>s + 1
                        }["InteractiveBackground.useEffect.handleClick"]);
                        playPop();
                        // push a short-lived ring marker so clicks are visibly obvious
                        particlesRef.current.push({
                            x: b.x,
                            y: b.y,
                            vx: 0,
                    ...
                    if (underlying && (underlying.tagName === "A" || underlying.tagName === "BUTTON" || underlying.closest("button") || underlying.closest("a"))) {
                        underlying.click();
                    }
                }
            }["InteractiveBackground.useEffect.handleClick"];
            ...
            const animate = {
                "InteractiveBackground.useEffect.animate": ()=>{
                    ...
                    for (const b of bubblesRef.current){
                        b.x += b.vx;
                        b.y += b.vy;
                        // much gentler upward acceleration
                        b.vy -= 0.002 * (Math.random() * 0.4 + 0.8);
                        if (b.x < -50) b.x = w + 50;
                        if (b.x > w + 50) b.x = -50;
                        if (b.y < -80) b.y = h + 80;
                        if (b.y > h + 80) b.y = -80;
                        ctx.beginPath();
                        // Use an indigo tint for higher contrast against background
                        ctx.fillStyle = "rgba(79,70,229,0.18)"; // indigo-600-ish
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-white/70 backdrop-blur-sm text-indigo-800 px-3 py-1 rounded-full font-medium",
                    children: [
                        "Score: ",
                        score
                    ]
...
_s(InteractiveBackground, "2e/XfofqwxmCw/tO6kLpFJKrg7A=");
...
function Hero() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pt-20",
        children: [
...
//# sourceMappingURL=app_d986db57._.js.map